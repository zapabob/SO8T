...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    // SO8T specific tensors
    {LLM_TENSOR_SO8T_ROTATION_SAFE,         {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},  // 8x8 rotation matrix
    {LLM_TENSOR_SO8T_ROTATION_CMD,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},  // 8x8 rotation matrix
    {LLM_TENSOR_SO8T_TASK_HEAD,             {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL_MAT}},     // Task reasoning head
    {LLM_TENSOR_SO8T_SAFETY_HEAD,           {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL_MAT}},     // Safety reasoning head
    {LLM_TENSOR_SO8T_AUTHORITY_HEAD,        {LLM_TENSOR_LAYER_OUTPUT, GGML_OP_MUL_MAT}},     // Authority reasoning head
};
