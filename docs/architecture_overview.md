...
- agents/so8t/model.py: Implements TinyNCGTransformerSO8T with SO(8) gating and PET loss.
- train.py / eval.py / infer.py: End-to-end pipeline scripts.
- agents/cli.py: Command entry point for codexCLI orchestration.
