...
## データセット情報
- **総チャンク数**: 0
- **作成日時**: 2025-11-07T01:38:52.385696
- **チャンクサイズ**: 512 文字
- **オーバーラップ**: 128 文字
...
client = Client(Settings(
    ...
    persist_directory="data\web_crawled_test\rag_ready/vector_db"
))
...
for file in Path('data\web_crawled_test\rag_ready').glob('rag_chunks_*.jsonl'):
