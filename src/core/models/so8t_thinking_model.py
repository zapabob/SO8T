...
from src.models.so8_quad_inference import SO8RotationGate, QuadrupleInference
from src.inference.nkat_thermostat import NKATDynamicTemperature
...
if __name__ == "__main__":
    ...
    # NKAT Thermostat設定
    from src.inference.nkat_thermostat import create_nkat_thermostat
