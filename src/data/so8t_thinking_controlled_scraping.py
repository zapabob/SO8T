...
# 既存の並列スクレイピングをインポート
try:
    from src.data.parallel_deep_research_scraping import (
...
# 監査ログインポート
try:
    from src.audit.scraping_audit_logger import ScrapingAuditLogger, ScrapingSession, ScrapingEvent
...
# 電源断保護インポート
try:
    from src.pipelines.power_failure_protected_scraping_pipeline import PowerFailureRecovery
