...
- [OK] Basic quality filters applied
- [OK] Statistical deduplication completed
- [OK] NKAT-SO8T specific filtering applied
- [OK] Category balancing completed
- [OK] Outlier removal performed
...
- Ready for NKAT-SO8T training: {'[OK] Yes' if stats.get('total_samples', 0) > 10000 else '[NG] No - Insufficient samples'}
"""
