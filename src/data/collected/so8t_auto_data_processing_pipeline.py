...
from src.pipelines.web_scraping_data_pipeline import DataCleaner, QuadrupleClassifier
from src.pipelines.incremental_labeling_pipeline import IncrementalLabeler

# エンコーディングユーティリティインポート
try:
    from src.utils.encoding_utils import safe_read_jsonl, safe_write_jsonl
    ...
    def __init__(self, config_path: Path):
        ...
        if self.use_so8t:
            try:
                ...
                try:
                    from src.utils.so8t_model_loader import find_so8t_model_paths, validate_so8t_model
