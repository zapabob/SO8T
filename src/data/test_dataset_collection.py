...
def test_dataset_collection():
    ...
    try:
        from src.data.dataset_collection_cleansing import DatasetCollectionCleansing
...
if __name__ == '__main__':
    ...
    try:
        ...
        print(f"[NG] datasets not available: {e}")
        has_datasets = False
    ...
    try:
        ...
        print(f"[NG] PIL not available: {e}")
        has_pil = False
    ...
    print(f"Soul weights: {'[OK]' if soul_result else '[NG]'}")
    print(f"Collection: {'[OK]' if collection_result else '[NG]'}")
