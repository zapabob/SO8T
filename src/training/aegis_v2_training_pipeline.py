...
# カスタムモジュールインポート
try:
    from src.training.ppo_internal_inference import PPOInternalInferenceTrainer, MetaInferenceController
    from src.training.alpha_gate_annealing import SigmoidAlphaGateAnnealing
    from src.models.so8_quad_inference import QuadrupleInference, PhDLevelInferenceAugmentor
    from src.data.dataset_collection_cleansing import create_ppo_training_dataset
...
try:
    from src.models.so8vit import SO8VIT
...
def main():
    ...
    # AEGIS-v2.0パイプライン実行
    try:
        from src.training.aegis_v2_training_pipeline import run_complete_aegis_v2_pipeline
