    ...
    def __init__(
        ...
        **kwargs
        ...
        if self.save_metrics and hasattr(self.args, 'output_dir'):
            try:
                from src.utils.training_metrics_recorder import TrainingMetricsRecorder
...
def optimize_hyperparameters_with_bayesian_cv(config, model_path: str, dataset_path: Path, output_dir: Path):
    ...
    try:
        from src.training.hyperparameter_optimization_with_cv import HyperparameterOptimizer
    except ImportError as e:
