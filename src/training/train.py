...
def main():
    ...
    print("[TARGET] SO8T Training Pipeline")
    print("=" * 50)
    ...
    print(f"[OK] Model loaded: {config['model']['base_model']}")
    ...
    # Step 4: Load data
    print("\n[STATS] Step 4: Loading training data...")
    ...
    print(f"[OK] Evaluation completed: {metrics}")
