...
# カスタムモジュール
from src.models.so8_quad_inference import SO8RotationGate
from src.training.nkat_reward_function import NKATRewardFunction
from src.inference.nkat_thermostat import NKATThermostat
...
class NKATPPOTrainer:
    ...
    def __init__(self, config: PPOConfig):
        ...
        if latest_ckpt:
            ...
            logger.info("[NEW] Starting new training session")
