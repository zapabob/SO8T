...
try:
    from src.pipelines.checkpoint_manager import CheckpointManager
    from src.pipelines.dataset_creator import DatasetCreator
    from src.pipelines.vector_store_creation import RAGVectorStoreCreator, CoGKnowledgeGraphCreator
...
class UnifiedAutoScrapingPipeline:
    ...
    async def run_pipeline_session(self) -> bool:
        ...
        try:
            ...
            logger.info(f"[SESSION] Starting pipeline session with {len(enabled_scripts)} src...")
