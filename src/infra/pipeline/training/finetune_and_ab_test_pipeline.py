...
class FinetuneAndABTestPipeline:
    ...
    def step1_convert_data(self) -> Path:
        ...
        from src.training.convert_four_class_to_hf_dataset import FourClassToHFDatasetConverter
    ...
    def step2_finetune(self, dataset_path: Path) -> Path:
        ...
        from src.training.finetune_hf_model_with_processed_data import HFModelFinetuner
    ...
    def step3_replace_so8t(self, finetuned_model_path: Path) -> Path:
        ...
        from src.training.replace_so8t_with_finetuned_hf import SO8TModelReplacer
    ...
    def step4_ab_test(self, finetuned_model_path: Path) -> Dict:
        ...
        import torch
        from src.evaluation.ab_test_so8t_vs_finetuned_hf import ABTestEvaluator
