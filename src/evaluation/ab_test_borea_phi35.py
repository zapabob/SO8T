...
from src.evaluate_model_a_baseline import (
    FourClassDataset,
    evaluate_model_a,
    calculate_metrics,
...
from src.evaluate_four_class import (
...
def evaluate_model_b_classifier(model_path: str, test_dataset, device, batch_size: int = 8):
    ...
    from src.train_four_class_classifier import FourClassModel
...
def main():
    ...
    from src.evaluate_four_class import evaluate_model, calculate_metrics as calc_metrics_b
