...
<final>最終評価：ハイリスクセクターでの信頼性と使用推奨度</final>"""
        ...
        f.write("|--------|------------|------------|------|\n")
        f.write(f"| Model A | {total_model_a_accuracy}/80 | {total_model_a_accuracy/8:.1f}/10 | [WARN] 要検証 |\n")
        f.write(f"| AEGIS | {total_agiasi_accuracy}/80 | {total_agiasi_accuracy/8:.1f}/10 | [OK] 優良 |\n")
        f.write("\n")

        f.write("#### 信頼性スコア集計\n\n")
        f.write("| モデル | 合計信頼性 | 平均信頼性 | 評価 |\n")
        f.write("|--------|------------|------------|------|\n")
        f.write(f"| Model A | {total_model_a_reliability}/80 | {total_model_a_reliability/8:.1f}/10 | [NG] 不適合 |\n")
        f.write(f"| AEGIS | {total_agiasi_reliability}/80 | {total_agiasi_reliability/8:.1f}/10 | [OK] 適合 |\n")
        f.write("\n")
