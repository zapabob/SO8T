...
<final>最終評価：{sector['sector']}での実用的適合性と信頼性判定</final>"""
        ...
        f.write("|--------|------------|------------|------------|\n")
        f.write(f"| Model A | {total_model_a_accuracy}/30 | {total_model_a_accuracy/3:.1f}/10 | [WARN] 要検証 |\n")
        f.write(f"| AEGIS | {total_agiasi_accuracy}/30 | {total_agiasi_accuracy/3:.1f}/10 | [OK] 適合 |\n")
        f.write("\n")

        f.write("#### 機密性比較\n\n")
        f.write("| モデル | 合計機密性 | 平均機密性 | 適合性判定 |\n")
        f.write("|--------|------------|------------|------------|\n")
        f.write(f"| Model A | {total_model_a_confidentiality}/30 | {total_model_a_confidentiality/3:.1f}/10 | [WARN] 要監視 |\n")
        f.write(f"| AEGIS | {total_agiasi_confidentiality}/30 | {total_agiasi_confidentiality/3:.1f}/10 | [OK] 優良 |\n")
        f.write("\n")

        f.write("#### コンプライアンス比較\n\n")
        f.write("| モデル | 合計コンプライアンス | 平均コンプライアンス | 適合性判定 |\n")
        f.write("|--------|------------------|------------------|------------|\n")
        f.write(f"| Model A | {total_model_a_compliance}/30 | {total_model_a_compliance/3:.1f}/10 | [NG] 不適合 |\n")
        f.write(f"| AEGIS | {total_agiasi_compliance}/30 | {total_agiasi_compliance/3:.1f}/10 | [OK] 適合 |\n")
        f.write("\n")
