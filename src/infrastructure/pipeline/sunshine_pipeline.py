...
from src.models.so8t_residual_adapter import replace_mlp_with_nkat
from src.utils.nkat_callbacks import NKATDebugCallback
...
# Import from src directory
# from src.models.so8t_residual_adapter import attach_nkat_adapters  # 削除済み関数
