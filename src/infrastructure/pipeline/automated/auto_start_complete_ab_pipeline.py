...
try:
    ...
    from src.utils.checklist_updater import ChecklistUpdater
...
# 自動再開マネージャーのインポート
try:
    from src.utils.auto_resume import AutoResumeManager
...
class AutoStartCompleteABPipeline:
    ...
    def run_pipeline_with_progress(self, resume_checkpoint: Optional[str] = None):
        ...
        # 統合パイプライン実行
        from src.pipelines.run_complete_automated_ab_pipeline import CompleteAutomatedABPipeline
