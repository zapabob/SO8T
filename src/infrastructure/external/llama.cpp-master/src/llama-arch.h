...
enum llm_tensor {
    ...
    LLM_TENSOR_SO8T_ROTATION_SAFE,    // 8x8 orthogonal rotation matrix for safety gate
    LLM_TENSOR_SO8T_ROTATION_CMD,     // 8x8 orthogonal rotation matrix for command gate
    LLM_TENSOR_SO8T_TASK_HEAD,        // Task reasoning head (vector representation)
    LLM_TENSOR_SO8T_SAFETY_HEAD,      // Safety reasoning head (spinor representation S+)
    LLM_TENSOR_SO8T_AUTHORITY_HEAD,   // Authority reasoning head (spinor representation S-)
};
