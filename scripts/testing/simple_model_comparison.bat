@echo off
chcp 65001 >nul
echo [SIMPLE COMPARISON] Model A vs AGIASI Golden Sigmoid
echo ==================================================
...
echo # Simple Benchmark: Model A vs AGIASI Golden Sigmoid >> "%RESULTS_FILE%"
echo. >> "%RESULTS_FILE%"
...
echo **AGIASI:** SO(8) enhanced model with four-value classification structure >> "%RESULTS_FILE%"
echo. >> "%RESULTS_FILE%"
echo **Key Differences:** >> "%RESULTS_FILE%"
echo - Model A provides conversational, natural responses >> "%RESULTS_FILE%"
echo - AGIASI provides structured analysis across four dimensions >> "%RESULTS_FILE%"
echo. >> "%RESULTS_FILE%"
