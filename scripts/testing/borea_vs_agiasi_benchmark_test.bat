@echo off
chcp 65001 >nul
echo [BENCHMARK] Borea-Phi3.5 vs AGIASI Comparison Test
echo ==================================================
echo Models: AGIASI-Golden vs Phi-3.5-Enhanced
echo ==================================================
...
echo # Borea-Phi3.5 vs AGIASI Benchmark Comparison Results > "%RESULTS_FILE%"
echo. >> "%RESULTS_FILE%"
echo **Test Date:** %date% %time% >> "%RESULTS_FILE%"
echo **Models Compared:** AGIASI-Golden (with SO(8) + Four-Value Classification) vs Phi-3.5-Enhanced >> "%RESULTS_FILE%"
echo. >> "%RESULTS_FILE%"

echo ## Testing Model: AGIASI-Golden >> "%RESULTS_FILE%"
echo. >> "%RESULTS_FILE%"
...
echo    - **AGIASI**: Uses structured four-value classification with XML tags >> "%RESULTS_FILE%"
echo    - **Phi-3.5-Enhanced**: Provides natural language responses >> "%RESULTS_FILE%"
echo. >> "%RESULTS_FILE%"
echo 2. **Analysis Depth:** >> "%RESULTS_FILE%"
echo    - **AGIASI**: Multi-perspective analysis (Logic, Ethics, Practical, Creative) >> "%RESULTS_FILE%"
echo    - **Phi-3.5-Enhanced**: Single-perspective analysis >> "%RESULTS_FILE%"
echo. >> "%RESULTS_FILE%"
echo 3. **Response Length:** >> "%RESULTS_FILE%"
echo    - **AGIASI**: Longer, more comprehensive responses >> "%RESULTS_FILE%"
